...
public class TicTacToe_s extends javax.swing.JFrame {
   ...
   static int hCount=0;
    ...
    private void bt6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt6ActionPerformed
        ...
        chance++;
        if(win(6)==1){
                         JOptionPane.showMessageDialog(this,"User Wins!","Tic Tac Toe Game",JOptionPane.INFORMATION_MESSAGE);
                         hCount++;
...
private JFrame frame;
    private void jbtnexitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnexitActionPerformed
        ...
        if(jbtnexit.getText()=="Start Game"){
            if(JOptionPane.showConfirmDialog(frame,"Do you want to Play first?","Tic Tac Toe Game",
 ...
 int b=PossWin(C);
   if(b!=0){
       ...
       blank[b-1]=0;
       cli(b);
             JOptionPane.showMessageDialog(this,"Computer Wins!","Tic Tac Toe Game",JOptionPane.INFORMATION_MESSAGE);
             cCount++;
             gameScore();
   ...
   if(k!=0){
     ...
     JOptionPane.showMessageDialog(this,"It's a Tie!","Tic Tac Toe Game",JOptionPane.INFORMATION_MESSAGE);
     t++;
     tie.setText("Ties: "+t);
   ...
   if(x==9){
                          JOptionPane.showMessageDialog(this,"Its a Tie!","Tic Tac Toe Game",JOptionPane.INFORMATION_MESSAGE);
                          t++;
     tie.setText("Ties: "+t);
